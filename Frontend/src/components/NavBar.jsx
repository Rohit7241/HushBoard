...
function NavBar() {
  ...
  return (
   <nav className='z-50 top-0 fixed w-full bg-black flex items-center flex text-sky-200 border-2 rounded-lg border-sky-200 shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_1px_#08f,0_0_10px_#08f,0_0_10px_#08f]'>
    ...
    <Link to="/Create" className='p-4 hover:text-sky-500 cursor-pointer'>Create Post</Link>
    <Link className='p-4 hover:text-sky-500 cursor-pointer' to="/">Home</Link>
    {isloggedin&&<Link to="/Profile"className='p-4 hover:text-sky-500' href="">Profile</Link>}
